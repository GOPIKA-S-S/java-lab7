...
public class AmazonCRMSystem {
    ...
    private static int lastOrderId = 100;
...
private static int customerIdCounter = 1; // Initialize customer ID counter
private static int productIdCounter = 1; // Initialize product ID counter
...
private static void addCustomer() {
    ...
    productIdCounter++;
        ...
        System.out.println("Product added successfully! product id is :"+ productId);
    }
